...
// countdown timer js 
$('#product_launch').countdown('2023/03/18', function(event) {
  var $this = $(this).html(event.strftime(''
    + '<div class="count_down_item"><span>%D <br> days</span></div> '
    + '<div class="count_down_item"><span>%H <br> hrs</span></div> '
    + '<div class="count_down_item"><span>%M <br> mins</span></div> '
    + '<div class="count_down_item"><span>%S <br> secs</span></div> '));
});
